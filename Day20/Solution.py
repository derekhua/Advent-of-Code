...
# Returns a set of all the factors of a number
def factors(n):
...
result = 0
house = 9
# Linear search... too lazy
while result < puzzle_input:
  house += 1
  result = sum([x * 10 for x in factors(house)])
  print result
print house
...
while result < puzzle_input:
  house += 1
  result = sum([x * 11 for x in factors(house) if house <= x*50])
  print result
print house
